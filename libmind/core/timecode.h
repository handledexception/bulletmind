...
extern void smpte_set_lo_word_value(smpte_tc_t* st, u8 val, u32 mask,
				    u32 shift);
extern u8 smpte_get_lo_word_value(smpte_tc_t* st, u32 mask, u32 shift);

extern void smpte_set_hi_word_value(smpte_tc_t* st, u8 val, u32 mask,
				    u32 shift);
...
extern void frames_to_timecode(u32 frames, fps_t fps, bool drop,
			       timecode_t* tc);
