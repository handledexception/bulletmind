...
set VC_VERSION=2019
set VC_ARCH=amd64
set BM_BUILD_DIR=build-release-x64
...
cmake -S. -B%BM_BUILD_DIR% -GNinja -DBM_BUILD_32BIT=OFF -DCMAKE_BUILD_TYPE=Release -DIMGUI_STATIC=TRUE -DBUILD_SHARED_LIBS=OFF
