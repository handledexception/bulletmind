...
void mat4f_perspective_fov_lh(mat4f_t* dst, f32 fov, f32 aspect, f32 z_near, f32 z_far)
{
    mat4f_zero(dst);
...
void mat4f_look_at_lh(mat4f_t* dst, const vec3f_t* pos, const vec3f_t* dir, const vec3f_t* up)
{
    vec3f_t look_vec;
