...
clang --std=c11 -g -O0 -Wall -m32 .\src\buffer.c .\src\command.c .\src\entity.c .\src\font.c .\src\sprite.c .\src\input.c .\src\render.c .\src\system.c .\src\timing.c .\src\main.c .\src\memarena.c -I.\src -I.\SDL2\include -L.\SDL2\lib\x86 -lkernel32 -lSDL2main -lSDL2 -Xlinker /SUBSYSTEM:console -o %BUILD_OUT_PATH%\bmind.exe
